			...
			<div class="col-md">
				<div class="ftco-footer-widget text-center">
					<ul class="ftco-footer-social list-unstyled mt-3">
						<li class="wow fadeIn"><a href="#"><span class="icon-twitter"></span></a></li>
						<li class="wow fadeIn"><a href="#"><span class="icon-facebook"></span></a></li>
						<li class="wow fadeIn"><a href="#"><span class="icon-instagram"></span></a></li>
					</ul>
				</div>
			</div>
		</div>
